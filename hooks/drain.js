...
export async function drain() {
  ...
  const context = [
    ...
    '2. Disposition EVERY message listed above — none may be silently ignored. For each: decide',
    '   incorporate/decline, reply to the sender, and ack it `acted`.',
    `3. If the user writes "@<name>: text", that text is addressed to <name>, not to you — relay it verbatim`,
